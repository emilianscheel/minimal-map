...
export const ZOOM_CONTROLS_POSITION_OPTIONS: ZoomControlPositionOption[] = [
	{ label: __( 'Top left', 'emilian-scheel-minimal-map' ), value: 'top-left', icon: arrowUpLeft as ReactElement },
	{ label: __( 'Top right', 'emilian-scheel-minimal-map' ), value: 'top-right', icon: arrowUpRight as ReactElement },
	{ label: __( 'Bottom left', 'emilian-scheel-minimal-map' ), value: 'bottom-left', icon: arrowDownLeft as ReactElement },
	{ label: __( 'Bottom right', 'emilian-scheel-minimal-map' ), value: 'bottom-right', icon: arrowDownRight as ReactElement },
];

export const ZOOM_CONTROLS_PLUS_ICON_OPTIONS: ZoomControlIconOption[] = [
	{
		label: __( 'Plus', 'emilian-scheel-minimal-map' ),
		value: 'plus',
		icon: plus as ReactElement,
		svg: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5 12h14"/><path d="M12 5v14"/></svg>',
	},
	{
		label: __( 'Plus circle', 'emilian-scheel-minimal-map' ),
		value: 'plus-circle',
	...
	{
		label: __( 'Filled plus circle', 'emilian-scheel-minimal-map' ),
...
export const ZOOM_CONTROLS_MINUS_ICON_OPTIONS: ZoomControlIconOption[] = [
	...
	{
		label: __( 'Close small', 'emilian-scheel-minimal-map' ),
		value: 'close-small',
