	...
	return useMemo(() => {
		if (category === 'selection') {
			return [
				{
					id: 'location_title',
					label: __('Location', 'emilian-scheel-minimal-map'),
				...
				},
				{
					...
					label: __('Source', 'emilian-scheel-minimal-map'),
					enableHiding: false,
					enableSorting: false,
					filterBy: false,
				...
				{
					id: 'query_text',
					label: __('Query', 'emilian-scheel-minimal-map'),
					enableHiding: false,
					enableSorting: false,
					filterBy: false,
				...
				{
					id: 'occurred_at_gmt',
					label: __('Time', 'emilian-scheel-minimal-map'),
					enableHiding: false,
					enableSorting: false,
					filterBy: false,
		...
		if (category === 'action') {
			return [
				...
				{
					id: 'action_type',
					label: __('Action', 'emilian-scheel-minimal-map'),
					enableHiding: false,
					enableSorting: false,
					filterBy: false,
				...
				{
					id: 'action_target',
					label: __('Target', 'emilian-scheel-minimal-map'),
					enableHiding: false,
					enableSorting: false,
					filterBy: false,
		...
		return [
			...
			{
				id: 'query_type',
				label: __('Query type', 'emilian-scheel-minimal-map'),
				enableHiding: false,
				enableSorting: false,
				filterBy: false,
			...
			{
				id: 'result_count',
				label: __('Results', 'emilian-scheel-minimal-map'),
				enableHiding: false,
				enableSorting: false,
				filterBy: false,
			...
			},
			{
				...
				label: __('Nearest store', 'emilian-scheel-minimal-map'),
				enableHiding: false,
				enableSorting: false,
				filterBy: false,
