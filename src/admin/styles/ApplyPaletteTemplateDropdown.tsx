		...
		<Dropdown
			...
			renderToggle={({ isOpen, onToggle }) => (
				<Button
					...
					label={__('Apply palette template', 'emilian-scheel-minimal-map')}
					disabled={disabled}
					isBusy={isBusy}
					__next40pxDefaultSize
				>
					{__('Templates', 'emilian-scheel-minimal-map')}
					<ChevronDown size={16} />
				</Button>
			)}
				renderContent={({ onClose }) => (
				<MenuGroup label={__('Palette Templates', 'emilian-scheel-minimal-map')}>
