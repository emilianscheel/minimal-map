	...
	if (step === 'details') {
		return (
			<div className="minimal-map-admin__location-dialog-fields">
				...
				/>
				<TextControl
					label={<OptionalLabel label={__('Telephone', 'emilian-scheel-minimal-map')} />}
					type="tel"
					value={form.telephone}
					onChange={(value) => onChange('telephone', value)}
				/>
				<TextControl
					label={<OptionalLabel label={__('Email address', 'emilian-scheel-minimal-map')} />}
					type="email"
					value={form.email}
				...
				/>
				<TextControl
					label={<OptionalLabel label={__('Website', 'emilian-scheel-minimal-map')} />}
					type="url"
					value={form.website}
				...
				/>
				<FormTokenField
					label={__('Tags (optional)', 'emilian-scheel-minimal-map')}
					value={form.tag_ids
	...
	return (
		<div className="minimal-map-admin__location-dialog-fields minimal-map-admin__location-dialog-fields--address">
			<div className="minimal-map-admin__location-dialog-grid minimal-map-admin__location-dialog-grid--row-one">
				<TextControl
					autoFocus
					label={__('Street', 'emilian-scheel-minimal-map')}
					value={form.street}
					onChange={(value) => onChange('street', value)}
					help={fieldErrors.street}
				/>
				<TextControl
					label={__('House number', 'emilian-scheel-minimal-map')}
			...
			<div className="minimal-map-admin__location-dialog-grid minimal-map-admin__location-dialog-grid--row-two">
				<TextControl
					label={__('Postal code', 'emilian-scheel-minimal-map')}
					value={form.postal_code}
					onChange={(value) => onChange('postal_code', value)}
					help={fieldErrors.postal_code}
				/>
				<TextControl
					label={__('City', 'emilian-scheel-minimal-map')}
					value={form.city}
			...
			<div className="minimal-map-admin__location-dialog-grid minimal-map-admin__location-dialog-grid--row-three">
				<TextControl
					label={__('State', 'emilian-scheel-minimal-map')}
					value={form.state}
					onChange={(value) => onChange('state', value)}
				/>
				<TextControl
					label={__('Country', 'emilian-scheel-minimal-map')}
					value={form.country}
